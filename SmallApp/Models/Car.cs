...
namespace SmallApp.Models
{
    public class Car
    {
        ...
        [Required]
        [StringLength (16, ErrorMessage = "The Car Name value cannot exceed 16 characters. ")]
        public string Name { get; set; }

        [Required]
        [StringLength(16, ErrorMessage = "The Car Model value cannot exceed 16 characters. ")]
